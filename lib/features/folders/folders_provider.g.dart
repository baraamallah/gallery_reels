...
final class TaggedPhotosProvider extends $FunctionalProvider<
  ...
  TaggedPhotosProvider._(
      {required TaggedPhotosFamily super.from, required String super.argument})
      : super(
          retry: null,
